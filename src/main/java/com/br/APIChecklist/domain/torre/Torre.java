...
import com.br.APIChecklist.domain.condominio.DadosAtualizacaoCondominio;
...
public class Torre {
    ...
    public void atualizarInformacoes(DadosAtualizacaoTorre dados, Long condominioId, CondominioRepository condominioRepository){
        this.condominio = condominioRepository.findById(condominioId)
                .orElseThrow(() -> new IllegalArgumentException("Condomínio não encontrado"));
        this.numero_torre = dados.numero_torre();
        this.quantidade_andares = dados.quantidade_andares();
